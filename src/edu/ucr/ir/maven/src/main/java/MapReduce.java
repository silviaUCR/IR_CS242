...
// true stands for recursively deleting the folder you gave
    ...
    MultipleInputs.addInputPath(job, new Path(args[0]), inverted_index.CustomInputFormat.class, inverted_index.MapInvertedIndex.class);
    job.setReducerClass(inverted_index.ReduceInvertedIndex.class);
